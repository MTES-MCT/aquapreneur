		...
		<div class="fr-footer__body">
			...
			<div class="fr-footer__content">
				<p class="fr-footer__content-desc">
					Aquapreneur est une startup d’État coportée par :
				</p>
				<ul class="fr-footer__content-desc fr-list">
					<li>
						le ministère de la Transition écologique, de la Biodiversité, de la
						Forêt, de la Mer et de la Pêche (DGAMPA, direction générale des
				...
				<p class="fr-footer__content-desc">
					avec l’appui de la Fabrique Numérique de l’Écologie.
				</p>
