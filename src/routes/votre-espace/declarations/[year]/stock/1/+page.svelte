...
<p>
  Cette étape concerne votre volume en stock à la fin de votre exercice comptable. Vous devrez
  confirmer ou compléter les informations relative à votre stock selon l’espèce et le stade
  d’élevage.
</p>

<NavigationLinks prevHref="../production/2" nextHref="2" />
