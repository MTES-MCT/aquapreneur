...
<div class="fr-container">
	<div class="fr-grid-row">
		<div class="fr-col-8 fr-py-12v" id="contenu">
			...
			<p>
				La plateforme « Aquapreneur » est éditée par la Fabrique numérique et la
				Direction générale des affaires maritimes, de la pêche et de
				l’aquaculture (DGAMPA) du ministère de la Transition écologique et de la
				Cohésion des territoires, située :
			</p>
			<p>
				1 place Carpeaux
				<br />
			...
			<p>
				...
				France
				<br />
				<ExternalLink href="https://scalingo.com/fr" title="Scalingo">
					Scalingo
				</ExternalLink>
			</p>
			...
			<p>
				...
				un contenu ou une fonctionnalité du site, merci de nous en faire part : <a
