<div class="fr-container">
  <div class="fr-grid-row">
    <div class="fr-col-8 fr-py-12v" id="contenu">
      ...
      <p>
        Le présent document a pour objectif d’encadrer l’utilisation de la plateforme Aquapreneur
        qui est d’accès libre et gratuit.
      </p>
      <p>
        Toute utilisation du Service par un Utilisateur ou Agent Public est subordonnée à
        l’acceptation préalable et au respect intégral des présentes conditions générales
        d’utilisation.
      </p>
      <p>L’usage de la langue française y est obligatoire.</p>

      <h2>Article 2 – Présentation du Service</h2>

      <p>La plateforme Aquapreneur a pour objectifs de :</p>
      <ul>
        <li>
          Permettre aux titulaires d’une concession d’exploitation aquacole de télévalider leurs
          productions pré-saisies si les données sont accessibles ou de télédéclarer leurs
          productions dans les conditions prévues par les textes réglementaires ;
        </li>
        <li>
          Mettre à disposition des informations administratives et techniques partiellement
          publiques relatives aux concessions des exploitations aquacoles ;
        </li>
        <li>
      ...
      <p>
        « Service » : désigne toutes les fonctionnalités offertes par la plateforme Aquapreneur pour
        répondre à ses finalités.
      </p>
      <p>
        « Utilisateur » : personne physique ou morale inscrite sur le Service avec un « compte
        utilisateur » ou un « compte entreprise ».
      </p>
      <p>« Visiteur » : toute personne qui consulte ou utilise le Service.</p>
      ...
      <ul>
        ...
        <li>
          Visualiser une carte et une liste des concessions aquacoles délivrées (numéro de la
          concession, informations techniques de la parcelle, état de la parcelle avec les dates des
          arrêtés ou des enquêtes publiques).
        </li>
      </ul>

      <h3>4.2 Utilisateur</h3>
      ...
      <p>
        L’Utilisateur titulaire du compte peut inviter d’autres Utilisateurs pour gérer tout ou
        partie des données de l’entreprise et de ses déclarations.
      </p>
      <p>
        L’Utilisateur peut compléter le profil de son entreprise en ajoutant ses employés et
        dirigeants (nom, prénom, nationalité, fonction, régime de la sécurité sociale, diplôme).
      </p>

      <h4>b. Télédéclarer les productions aquacoles d’une entreprise</h4>

      <p>
        L’Utilisateur peut télédéclarer ses productions aquacoles dans les conditions prévues par
      ...
      <p>
        L’Utilisateur peut soumettre une demande de concession aquacole pour instruction des
        services de l’État. Cette fonctionnalité n’est pas effective dans la phase
        d’expérimentation.
      </p>
      ...
      <p>
        L’Utilisateur dispose d’une page qui liste les informations réglementaires sur l’aquaculture
        en France. Ces informations sont renseignées par les administrateurs de la plateforme.
      </p>

      <h3>4.3 Administrations</h3>
      ...
      <p>
        ...
        d’expérimentation, l’Agent Public ne pourra administrer l’outil mais simplement se mettre à
        la place d’un exploitant aquacole.
      </p>
      <p>
        ...
        son compte. Celle-ci est effective dans un délai deux mois suivant la demande.
      </p>

      <h2>Article 5. Qualité des données publiées</h2>

      <p>
        Les données publiées sur Aquapreneur ont un caractère informatif. Seules les publications
        légales font foi, notamment au Journal officiel de la République Française (JORF) ou aux
        recueils des actes administratifs des préfectures (RAA).
      </p>
      <p>
        Les informations publiées sur Aquapreneur ne sauraient engager la responsabilité de leur
        éditeur ou d’un quelconque service de l’État, toute personne y ayant recours a conscience
        des potentielles erreurs ou omissions qu’elles peuvent comporter. L’Administration s’efforce
        de livrer des données de la meilleure qualité possible. Toutefois, elles peuvent encore
      ...
      <p>
        ...
        l’aide du bouton « signaler une erreur » disponible pour chacune des fiches. Cette
        fonctionnalité n’est pas disponible dans la phase d’expérimentation.
      </p>
      <p>
      ...
      <p>
        Il s’engage à ne pas commercialiser les données reçues et à ne pas les communiquer à des
        tiers en dehors des cas prévus par la loi. Toute information transmise par l’Utilisateur est
        de sa seule responsabilité.
      </p>
      <p>
        Il est entendu que tous les Utilisateurs d’un même établissement sont co-responsables des
        déclarations et formalités administratives réalisées sur le Service.
      </p>
      <p>
      ...
      <h3>6.2 L’Administration</h3>

      <p>
        L’Administration s’autorise à suspendre ou révoquer n’importe quel compte et toutes les
        actions réalisées par ce biais, s’ils estiment que l’usage réalisé du Service porte
        préjudice à son image ou ne correspond pas aux exigences de sécurité.
      </p>
      <p>
        L’Administration s’engage à la sécurisation du Service, notamment en prenant toutes les
        mesures nécessaires permettant de garantir la sécurité et la confidentialité des
        informations fournies. L’Administration fournit les moyens nécessaires et raisonnables pour
        assurer un accès continu, sans contrepartie financière, au Service.
      </p>
      <p>
        Elle se réserve la liberté de faire évoluer, de modifier ou de suspendre, sans préavis, le
        Service pour des raisons de maintenance ou pour tout autre motif jugé nécessaire.
      </p>
      ...
      <p>
        ...
        méconnaissance par un Agent Public des présentes CGU peut donner lieu à des poursuites
        disciplinaires et devant les juridictions compétences.
      </p>
      ...
      <p>
        ...
        moment, sans préavis, en fonction des modifications apportées au Service, de l’évolution de
        la législation ou pour tout autre motif jugé nécessaire.
      </p>

      <!-- Vous pouvez avoir accès à l’historique des différentes versions des 
     conditions générales d’utilisation ici : 
     -->
    </div>
  </div>
</div>
