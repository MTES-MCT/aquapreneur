<div class="fr-grid-row">
  <div class="fr-col-8">
    ...
    <p>
      Le présent document a pour objectif d’encadrer l’utilisation de la plateforme Aquapreneur qui
    ...
    <p>
      ...
      des données de l’entreprise et de ses déclarations.
    </p>
    <p>
    ...
    <p>
      ...
      éditeur ou d’un quelconque service de l’État, toute personne y ayant recours a conscience des
      potentielles erreurs ou omissions qu’elles peuvent comporter. L’Administration s’efforce de
      livrer des données de la meilleure qualité possible. Toutefois, elles peuvent encore comporter
      des erreurs ou omissions.
    </p>
    <p>
      Toute personne qui constate une erreur ou omission parmi ces données peut la signaler à l’aide
      du bouton « signaler une erreur » disponible pour chacune des fiches. Cette fonctionnalité
      n’est pas disponible dans la phase d’expérimentation.
    </p>
    <p>
    ...
    <p>
      ...
      en dehors des cas prévus par la loi. Toute information transmise par l’Utilisateur est de sa
    ...
    <p>
      ...
      actions réalisées par ce biais, s’ils estiment que l’usage réalisé du Service porte préjudice
      à son image ou ne correspond pas aux exigences de sécurité.
    </p>
    <p>
      ...
      fournies. L’Administration fournit les moyens nécessaires et raisonnables pour assurer un
    ...
    <p>
      ...
      moment, sans préavis, en fonction des modifications apportées au Service, de l’évolution de la
