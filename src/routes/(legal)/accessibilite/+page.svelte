	...
	<div class="fr-grid-row">
		<div class="fr-col-8 fr-py-12v" id="contenu">
			...
			<p>
				...
				l’Aquaculture (DGAMPA) du ministère de la Transition écologique, de la
				Biodiversité, de la Forêt, de la Mer et de la Pêche s’engage à rendre
			...
			<p>
				...
				(https://aquapreneur.beta.gouv.fr).
			</p>
			<h2>État de conformité</h2>
			<p>
				<strong>Aquapreneur</strong>
				est
			...
			<p>
				L’accessibilité de <span>Aquapreneur</span>
			...
			<p>
				...
				pouvez contacter le responsable de la plateforme <span>
					Aquapreneur
				</span>
			...
			<ul>
				...
				<li>
					...
					<ExternalLink
						...
						title="délégué du Défenseur des droits"
					>
			...
			<hr />
			<p class="fr-text--xs">
				Cette déclaration d’accessibilité a été créé le 25 mars 2025 grâce au
				<ExternalLink
