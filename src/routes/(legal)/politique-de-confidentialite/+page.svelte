  ...
  <div class="fr-grid-row">
    <div class="fr-col-8 fr-py-12v" id="contenu">
      ...
      <p>
        ...
        et de l’Aquaculture (DGAMPA) du ministère de la Transition écologique, de la Biodiversité,
        de la Forêt, de la Mer et de la Pêche, représentée par son directeur général, Eric Banel.
      </p>
      ...
      <ul>
        ...
        <li>Communiquer des données économiques sur une exploitation aquacole ;</li>
        <li>Télédéclarer des productions aquacoles ;</li>
        <li>
          Soumettre une demande de concession aquacole (non disponible dans la phase
          d’expérimentation) ;
        </li>
        <li>
          Mettre en accès libre sur Internet des informations relatives aux exploitations aquacoles
          (non disponible dans la phase d’expérimentation).
        </li>
      </ul>

      <h2>III - Base légale</h2>

      <p>Aquapreneur traite des données à caractère personnel en se basant sur :</p>
      <ul>
        <li>
          L’exécution d’une mission d’intérêt public ou relevant de l’exercice de l’autorité
          publique dont est investi le responsable de traitement au sens de l’article 6-1 e) du
          RPGD ;
        </li>
        <li>
          Cette mission d’intérêt public découle des attributions confiées à la direction générale
          des Affaires maritimes, de la Pêche et de l’Aquaculture (DGAMPA) par l’article 9 du décret
          n° 2008-680, l’article 9.1.1 de l’arrêté du 9 juillet 2008 portant organisation des
          administrations centrales des ministères chargés de la transition écologique, de la
          cohésion des territoires et de la mer et l’article R. 923-11 du code rural et de la pêche
          maritime.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Données de création de compte et de connexion</strong> : Nom, prénom, adresse mail
        </li>
        <li>
          <strong>Données d’entreprise</strong> : nom, prénom, téléphone, courrier électronique
          ainsi que le nom de l’entreprise, numéros de SIREN, numéro de TVA intracommunautaire et
          l’adresse du siège social.
        </li>
        <li>
          <strong>Données relatives aux demandes d’une concession aquacole</strong> : Non disponible
          dans la phase d’expérimentation.
        </li>
        <li>
          <strong>Données des concessions d’exploitation aquacole en accès libre</strong> : toutes
          les informations nécessaires à l’établissement et la consultation d’une cartographie
          interactive qu’il s’agisse ou non de données à caractère personnel et notamment,
          géolocalisation de la parcelle cadastrale. Le nom de l’entreprise et l’identité du
          représentant légal ne sont pas disponibles dans la phase d’expérimentation.
        </li>
      </ul>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      5 ans en base active puis archivage intermédiaire jusqu’au terme de la durée
                      de la concession avant archivage définitif (article R. 923-10 du code rural et
                      de la pêche administrative prévoit que la durée maximum d’une concession est
                      de 35 ans)</td
                    >
                  </tr>
                  <tr>
      ...
      <p>
        Puisque ce sont des droits personnels, nous ne traiterons votre demande que si nous sommes
        en mesure de vous identifier. Dans le cas où nous ne parvenons pas à vous identifier, nous
        pouvons être amenés à vous demander une preuve de votre identité.
      </p>
      <p>
        Pour vous aider dans votre démarche, vous trouverez un modèle de courrier élaboré par la
        CNIL ici :
        <ExternalLink
          href="https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces"
          title="Exercer son droit d’accès">exercer son droit d’accès</ExternalLink
        >
      </p>

      <p>
        Nous nous engageons à vous répondre dans un délai raisonnable qui ne saurait dépasser 1 mois
        à compter de la réception de votre demande.
      </p>

      <h2>VII - Destinataires</h2>
      ...
      <p>
        Les agents des organisations professionnels, des centres techniques, des comités d’animation
        des filières pourront avoir accès à des données dans un cadre juridique qu’il reste à
        déterminer.
      </p>
      ...
      <p>
        Certaines des données sont envoyées à d’autres acteurs, appelés « sous-traitants de
        données », pour qu’ils nous aident à les manipuler. Nous nous assurons qu’ils respectent
        strictement le RGPD et qu’ils apportent des garanties suffisantes en matière de sécurité.
      </p>
      ...
      <p>
        ...
        constitue une base légale au sens du RGPD et doit être entendu au sens de l’article 6-1 a)
        du RGPD et à la libre circulation des données.
      </p>
      ...
      <p>
        ...
        notamment sur Microsoft Edge, Google Chrome, Mozilla Firefox, Apple Safari et Opera).
      </p>
      <p>
      ...
      <ul>
        <li>
          <ExternalLink
            ...
            title="Cookies & traceurs : que dit la loi ?"
            >Cookies & traceurs : que dit la loi ?</ExternalLink
          >
        </li>
        ...
        <li>
          <ExternalLink
            ...
            >Cookies : les outils pour les maîtriser</ExternalLink
          >
        </li>
      </ul>
    </div>
