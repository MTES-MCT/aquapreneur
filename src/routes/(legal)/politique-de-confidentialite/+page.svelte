	...
	<div class="fr-grid-row">
		<div class="fr-col-8 fr-py-12v" id="contenu">
			...
			<p>
				...
				soient conformes au règlement européen n° 2016/679 général sur la
				protection des données du 27 avril 2016 dit « RGPD » et à la loi
				n° 78-17 relative à l’informatique, aux fichiers et aux libertés dite
				« LIL ».
			</p>
			...
			<ul>
				<li>
					Permettre aux titulaires d’une concession d’exploitation aquacole de
					télévalider leurs productions pré-saisies si les données sont
					accessibles ou de télédéclarer leurs productions dans les conditions
					prévues par les textes réglementaires ;
				</li>
				<li>
					Mettre à disposition des informations administratives et techniques
					partiellement publiques relatives aux concessions des exploitations
					aquacoles ;
				</li>
				<li>
					À terme de proposer une carte interactive des concessions
					d’exploitation aquacoles ;
				</li>
				<li>
					Accompagner les entreprises face aux aléas et aux pertes de
					production.
				</li>
			</ul>
			...
			<p>
				Le responsable de traitement est la direction générale des Affaires
				maritimes, de la Pêche et de l’Aquaculture (DGAMPA) du ministère de la
				Transition écologique, de la Biodiversité, de la Forêt, de la Mer et de
				la Pêche, représentée par son directeur général, Eric Banel.
			</p>

			<h2>II - Finalités</h2>

			<p>
				Aquapreneur est un service numérique qui traite des données à caractère
			...
			<ul>
				...
				<li>
					Soumettre une demande de concession aquacole (non disponible dans la
					phase d’expérimentation) ;
				</li>
				<li>
					Mettre en accès libre sur Internet des informations relatives aux
					exploitations aquacoles (non disponible dans la phase
					d’expérimentation).
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					Cette mission d’intérêt public découle des attributions confiées à la
					direction générale des Affaires maritimes, de la Pêche et de
					l’Aquaculture (DGAMPA) par l’article 9 du décret n° 2008-680,
					l’article 9.1.1 de l’arrêté du 9 juillet 2008 portant organisation des
					administrations centrales des ministères chargés de la transition
					écologique, de la cohésion des territoires et de la mer et l’article
					R. 923-11 du code rural et de la pêche maritime.
				</li>
			</ul>
			...
			<ul>
				<li>
					<strong>Données de création de compte et de connexion</strong>
					 : Nom, prénom, adresse mail
				</li>
				<li>
					<strong>Données d’entreprise</strong>
					 : nom, prénom, téléphone, courrier électronique ainsi que le nom de l’entreprise,
					numéros de SIREN, numéro de TVA intracommunautaire et l’adresse du siège
					social.
				</li>
				<li>
					<strong>
						Données relatives aux demandes d’une concession aquacole
					</strong>
					 : Non disponible dans la phase d’expérimentation.
				</li>
				<li>
					<strong>
						Données des concessions d’exploitation aquacole en accès libre
					</strong>
					 : toutes les informations nécessaires à l’établissement et la consultation
					d’une cartographie interactive qu’il s’agisse ou non de données à caractère
					personnel et notamment, géolocalisation de la parcelle cadastrale. Le nom
					de l’entreprise et l’identité du représentant légal ne sont pas disponibles
							...
							<table>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											5 ans en base active puis archivage intermédiaire jusqu’au
											terme de la durée de la concession avant archivage
											définitif (article R. 923-10 du code rural et de la pêche
											administrative prévoit que la durée maximum d’une
											concession est de 35 ans)
										</td>
									</tr>
									<tr>
										<td>Cookies</td>
			...
			<p>
				Pour les exercer, contactez-nous à : <a
					href="mailto:aquapreneur@beta.gouv.fr"
				>
					aquapreneur@beta.gouv.fr
				</a>
				.
			</p>
			...
			<p>
				...
				<ExternalLink
					...
					title="Exercer son droit d’accès"
				>
			...
			<p>
				Durant la phase d’expérimentation, seuls les agents publics et
				prestataires de l’équipe Aquapreneur (DGAMPA et SSP) ont accès aux
				données.
			</p>
			<p>
				Suite à l’expérimentation, les personnes suivantes vont avoir accès aux
				données :
			</p>
							...
							<table>
								...
								<tbody>
									<tr>
										<td>Données de création de compte et de connexion</td>
										<td>
											Agents publics et personnels habilités des services
									...
									<tr>
										...
										<td>
											...
											déconcentrés de l’État
											<br />
											Les personnels habilités de l’Agence Française pour le développement
											et la promotion de l’agriculture biologique (Agence Bio)
										</td>
									</tr>
									<tr>
										<td>
			...
			<p>
				Les agents des organisations professionnels, des centres techniques, des
				comités d’animation des filières pourront avoir accès à des données dans
				un cadre juridique qu’il reste à déterminer.
			</p>
								...
								<tbody>
									<tr>
										...
										<td>
											...
											>
												Contrat de Gestion des Traitements de Données
												Personnelles
											</ExternalLink>
										</td>
									</tr>
			...
			<p>
				...
				entendu au sens de l’article 6-1 a) du RGPD et à la libre circulation
				des données.
			</p>
			...
			<p>
				...
				de votre navigateur (fonction disponible notamment sur Microsoft Edge,
