...
{#if dirigeant.prenomNom || dirigeant.anneeNaissance || dirigeant.sexe || dirigeant.statut || dirigeant.tempsTravail || dirigeant.diplome || dirigeant.regimeSocial}
	{#if dirigeant.prenomNom || dirigeant.anneeNaissance || dirigeant.sexe}
		...
		<div style="display: flex; width: 100%; justify-content: stretch;">
			...
			<div style="flex-grow: 1">
				...
				{/if}
				{#if dirigeant.nationalite}
					{COUNTRIES.find((c) => c.iso_alpha2 === dirigeant.nationalite)
						?.label || ""}
					<br />
				{/if}
				{#if dirigeant.sexe}
	...
	{#if dirigeant.statut || dirigeant.tempsTravail || dirigeant.diplome || dirigeant.regimeSocial}
		...
		<div style="display: flex; width: 100%; justify-content: stretch;">
			...
			<div style="flex-grow: 1">
				...
				{/if}
				{#if dirigeant.regimeSocial}
					{REGIMES_SOCIAUX.find((r) => r.id === dirigeant.regimeSocial)
						?.label || ""}
				{/if}
			</div>
		</div>
